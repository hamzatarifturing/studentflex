...
function generateResult($conn, $student_id, $exam_id) {
    ...
    if ($marks_result->num_rows > 0) {
        ...
        // Calculate rank (simplified approach - just a placeholder)
        $rank = 0;
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT m.id, m.student_id, m.subject_id, m.exam_id, 
                                         ...
                                         m.created_at, u.full_name AS student_name, s.student_id AS student_roll_id, 
                                ...
                                if ($result && $result->num_rows > 0) {
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="13" class="text-center">No mark entries found</td>
                                    </tr>
                                <?php
                                }
                                ?>
