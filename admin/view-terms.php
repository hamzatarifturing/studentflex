        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="add-terms.php" class="btn btn-sm btn-primary">
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-<?php echo $currentClass; ?>"><?php echo $isCurrent; ?></span></td>
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="8" class="text-center">No terms found. <a href="add-terms.php">Add a term</a></td>
                                    </tr>
                                    <?php
                                }
                                ?>
...
<!-- Initialize the DataTable for better user experience -->
<script>
